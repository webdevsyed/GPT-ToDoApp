  ...
  return (
    <div className="flex w-screen">
      <Navbar
        fluid={true}
        rounded={true}
        className='shadow-md w-full pl-3 sm:py-3 dark:bg-[#242424]'
      >

        <Navbar.Brand href="#" className="w-fit xl:ml-40 mx-auto sm:mx-0">
          <img
            src="\favicon-96.png"
        ...
        <div className="flex justify-end pr-3 mt-2 w-full sm:w-fit sm:mt-0 sm:mx-0 md:order-2 xl:mr-40 sm:pl-24">
          ...
          {/* Settings Button
          <button id="theme-toggle" type="button" className="overflow-hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
          ...
          {/* <Dropdown
            ...
            label={<div id="theme-toggle" type="button" className="overflow-hidden text-gray-500 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-700 focus:outline-none focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-700 rounded-lg text-sm p-2.5"><svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink"
              width="22px" height="22px" fill="currentColor" viewBox="0 0 340 340"
              xmlSpace="preserve">
              <g>
                <g>
